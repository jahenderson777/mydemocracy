     ...
     [:a {:href "/", :class "govuk-header__link govuk-header__link--homepage"}
      [:span {:class "govuk-header__logotype"}
       [:svg {:aria-hidden "true", :focusable "false", :class "govuk-header__logotype-crown", :xmlns "http://www.w3.org/2000/svg", :viewBox "0 0 132 97", :height "30", :width "36"}
        ...
        [:image {:src "/assets/images/govuk-logotype-crown.png", :display "none", :class "govuk-header__logotype-crown-fallback-image", :width "36", :height "32"}]]
...
(defn layout-2-thirds-col [{:keys [title l-header l-lead l-content r-header r-content]}]
